...
class Version:
    ...
    def minor(self) -> int: ...
    def patch(self) -> int: ...
    def to_string(self, include_build: bool = True) -> str: ...
...
class IPlugin:
    ...
    def initialize(self) -> Any: ...  # Returns expected<void, PluginError>
    def state(self) -> PluginState: ...
    def capabilities(self) -> int: ...  # PluginCapabilities (bitfield)
    def priority(self) -> PluginPriority: ...
    def is_initialized(self) -> bool: ...
    def __repr__(self) -> str: ...

class PluginLoadOptions:
    """Plugin loading configuration options."""
    def __init__(self) -> None: ...
    validate_sha256: bool
    expected_sha256: str
...
class PluginManager:
    ...
    def __init__(self) -> None: ...
    def load_plugin(self, file_path: Path, options: PluginLoadOptions = ...) -> Union[str, Dict[str, Any]]: ...
    def unload_plugin(self, plugin_id: str, force: bool = False) -> Union[bool, Dict[str, Any]]: ...
    ...
    def discover_plugins(self, directory: Path, recursive: bool = False) -> List[Path]: ...
...
def create_metadata(name: str, description: str, version: Version = ...) -> PluginMetadata:
