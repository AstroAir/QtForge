...
void TestLifecycleCompilation::testClassAvailability() {
    ...
    // We can't instantiate it due to MOC issues, but we can verify the type exists
...
void TestLifecycleCompilation::testStateMachineAvailability() {
    ...
    // This class should be fully functional since it doesn't inherit from QObject
