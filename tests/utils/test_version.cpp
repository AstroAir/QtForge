...
private:
    ...
    void testVersionComparison(const std::string& v1, const std::string& v2,
                               int expected_result);
};
...
void TestVersion::verifyVersionComponents(const Version& version, int major,
                                          int minor, int patch) {
...
void TestVersion::verifyVersionString(const Version& version,
                                      const std::string& expected) {
    QCOMPARE(version.to_string(), expected);
}

void TestVersion::testVersionComparison(const std::string& v1_str,
