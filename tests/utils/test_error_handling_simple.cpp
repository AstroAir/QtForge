...
void TestErrorHandlingSimple::testExpectedError() {
    auto result =
        make_error<int>(PluginErrorCode::InvalidArgument, "Test error");
    QVERIFY(!result.has_value());
    QVERIFY(result.has_error());
...
void TestErrorHandlingSimple::testExpectedValueAccess() {
    ...
    auto error_result =
        make_error<int>(PluginErrorCode::InvalidArgument, "Error");
...
void TestErrorHandlingSimple::testMakeError() {
    auto simple_error = make_error<std::string>(PluginErrorCode::FileNotFound,
                                                "File not found");
...
expected<std::string, PluginError> TestErrorHandlingSimple::process_string(
...
void TestErrorHandlingSimple::verify_error(
    const PluginError& error, PluginErrorCode expected_code,
    const std::string& expected_message) {
