...
def verify_complete_coverage():
        ...
        for expected_file in expected_files:
            ...
            if test_file.exists():
                ...
                if file_size > 1000:  # At least 1KB
                    ...
                    print(f"      ⚠️  {expected_file} (too small: {file_size} bytes)")
            else:
                print(f"      ❌ Missing {expected_file}")
                structure_issues.append(f"Missing test file: {module}/{expected_file}")
    ...
    if main_cmake.exists():
        ...
        if missing_includes:
            ...
            for module in missing_includes:
                ...
                structure_issues.append(f"Missing add_subdirectory({module}) in main CMakeLists.txt")
        else:
    ...
    if not missing_modules and not structure_issues:
        ...
        print(f"   ✅ All {len(expected_test_modules)} modules have test coverage")
