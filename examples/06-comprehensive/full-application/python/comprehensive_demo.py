...
class ComprehensivePythonDemo:
        ...
        try:
            ...
            if self.config.enable_security:
                ...
                self.security_manager.set_security_level(
                    getattr(qtforge.SecurityLevel, self.config.security_level.title())
                )
    ...
    def setup_message_handlers(self):
        ...
        # Subscribe to topics
        self.message_bus.subscribe_to_topic("python_demo", "plugin.*", on_plugin_message)
        self.message_bus.subscribe_to_topic("python_demo", "system.*", on_system_message)
    ...
    def load_plugins(self) -> bool:
        ...
        try:
            # Load plugins
            result = self.plugin_manager.load_plugin_directory(self.config.plugin_directory)
            ...
            if result.is_valid:
                ...
                for plugin_id in loaded_plugins:
                    ...
                    if plugin:
                        print(f"  - {plugin.name()} v{plugin.version()} ({plugin_id})")
        ...
        try:
            ...
            for plugin_id in plugins[:3]:  # Test first 3 plugins
                ...
                if plugin:
                    ...
                    echo_params = {"message": "Hello from Python!", "timestamp": str(datetime.now())}
    ...
    def demonstrate_communication(self):
        ...
        try:
            ...
            self.message_bus.publish_basic("demo.python", "python_demo", test_message)
    ...
    def demonstrate_security(self):
        ...
        try:
            ...
            validation_result = self.security_manager.validate_plugin("./plugins/comprehensive_plugin.qtplugin")
            if validation_result.is_valid:
                print("✅ Plugin validation passed")
            else:
                print(f"⚠️ Plugin validation: {validation_result.error_message}")
            
            # Trust management
            self.security_manager.add_trusted_plugin("com.qtforge.comprehensive_plugin")
    ...
    def demonstrate_monitoring(self):
        ...
        try:
            ...
            # System metrics
            system_metrics = qtforge.monitoring.get_system_metrics(qtforge.create_plugin_registry())
            print(f"💻 System CPU: {system_metrics.get('cpu_usage', 'N/A')}%")
            print(f"💾 Memory usage: {system_metrics.get('memory_usage', 'N/A')} MB")
    ...
    def demonstrate_workflows(self):
        ...
        try:
            ...
            workflow = qtforge.create_workflow("python_demo_workflow", "Python Demo Workflow")
            
            # Add workflow steps
            step1 = qtforge.create_workflow_step("validate", "comprehensive_plugin", "status")
            step2 = qtforge.create_workflow_step("process", "comprehensive_plugin", "process_data")
            step3 = qtforge.create_workflow_step("finalize", "comprehensive_plugin", "echo")
    ...
    def demonstrate_marketplace(self):
        ...
        try:
            ...
            results = qtforge.search_free_plugins(self.marketplace, "comprehensive")
