...
private slots:
    ...
    void showSettings() {
        ...
        connect(settings_dialog, &SettingsDialog::settingsChanged,
    ...
    void applyTheme(const QString& theme_name) {
        if (m_plugin_core) {
            ...
            if (!result) {
                ...
                statusBar()->showMessage(QString("Theme applied: %1").arg(theme_name), 2000);
            }
        }
    }
...
private:
    void setupUI() {
        ...
        auto welcome_label = new QLabel(
            ...
            "<p>This example demonstrates the reorganized UI plugin structure with:</p>"
            "<ul>"
        ...
        connect(demo_button, &QPushButton::clicked, this, &MainWindow::showDemoWidget);
        button_layout->addWidget(demo_button);
        
        auto settings_button = new QPushButton("Settings");
        connect(settings_button, &QPushButton::clicked, this, &MainWindow::showSettings);
    ...
    void setupMenus() {
        ...
        connect(show_demo_action, &QAction::triggered, this, &MainWindow::showDemoWidget);
        ...
        for (const auto& theme : themes) {
            ...
            connect(theme_action, &QAction::triggered, this, [this, theme]() {
                applyTheme(theme);
            });
        }
        ...
        connect(status_action, &QAction::triggered, this, &MainWindow::showPluginStatus);
