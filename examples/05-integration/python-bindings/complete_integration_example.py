...
class QtForgeCompleteExample:
    ...
    def initialize_qtforge(self) -> bool:
        ...
        try:
            ...
            print(
                f"✅ Version info: {qtforge.__version_major__}.{qtforge.__version_minor__}.{qtforge.__version_patch__}"
            )
    ...
    def run_complete_example(self) -> int:
        ...
        if passed_tests == total_tests:
            print(
                "🎉 All tests passed! QtForge Python integration is working perfectly."
            )
            return 0
        if passed_tests > 0:
            print(
                "⚠️  Some tests passed. QtForge Python integration is partially working."
            )
            return 0
