                    ...
                    if set_metadata_func:
                        ...
                        try:
                            ...
                            try:
                                ...
                                print(
                                    f"  ⚠️  Could not set metadata {key}: incompatible signature"
                                )
                                continue
                        print(f"  ✅ Set {key}: {value}")
                    else:
                        print("  ⚠️  set_metadata method not available")
                except Exception as e:
...
def demonstrate_message_priorities() -> None:
    ...
    if hasattr(comm, "BasicMessage"):
        try:
            ...
            if (
                hasattr(message, "set_priority")
                and hasattr(comm, "MessagePriority")
                and hasattr(comm.MessagePriority, "High")
            ):
            ...
            if (
                hasattr(message, "set_delivery_mode")
                and hasattr(comm, "DeliveryMode")
                and hasattr(comm.DeliveryMode, "Persistent")
            ):
...
def demonstrate_service_contracts() -> None:
    ...
    if hasattr(comm, "ServiceContract"):
        try:
            ...
            if hasattr(contract, "add_method") and hasattr(
                comm, "ServiceMethodDescriptor"
            ):
...
def demonstrate_request_response() -> None:
    ...
    if bus and hasattr(bus, "send_request") and hasattr(comm, "Request"):
        ...
        try:
            ...
            print(
                f"⚠️  Request-response failed: {e} (this is expected if no service is running)"
            )
