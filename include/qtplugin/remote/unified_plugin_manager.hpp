 ...
 *
 * This class provides a unified interface for managing both local and remote
 * plugins. It supports configurable load strategies, automatic updates, and
 * seamless fallback between local and remote sources.
 */
...
signals:
     ...
     */
    void pluginLoadFailed(const QString& pluginId, const QString& localPath,
