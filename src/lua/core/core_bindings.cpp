...
#include "../../../include/qtplugin/interfaces/core/dynamic_plugin_interface.hpp"
...
void register_version_bindings(sol::state_view& lua) {
    auto version_type = lua.new_usertype<qtplugin::Version>(
        "Version", sol::constructors<qtplugin::Version(int, int, int)>());
    ...
    version_type[sol::meta_function::to_string] =
        [](const qtplugin::Version& v) { return v.to_string(); };
}
...
void register_advanced_interfaces_bindings(sol::state_view& lua) {
    // Plugin type enum
    lua.new_enum<qtplugin::PluginType>(
        "PluginType", {{"Native", qtplugin::PluginType::Native},
    ...
    lua.new_enum<qtplugin::ServicePriority>(
        "ServicePriority", {{"Idle", qtplugin::ServicePriority::Idle},
    ...
    // Service health enum
    lua.new_enum<qtplugin::ServiceHealth>(
        "ServiceHealth", {{"Unknown", qtplugin::ServiceHealth::Unknown},
...
void register_plugin_state_bindings(sol::state& lua) {
    // PluginState enum
    lua.new_enum<qtplugin::PluginState>(
        "PluginState", {{"Unloaded", qtplugin::PluginState::Unloaded},
    ...
    lua.new_enum<qtplugin::PluginCapability>(
        "PluginCapability",
    ...
    // PluginPriority enum
    lua.new_enum<qtplugin::PluginPriority>(
        "PluginPriority", {{"Lowest", qtplugin::PluginPriority::Lowest},
...
void register_error_handling_bindings(sol::state& lua) {
    ...
    lua.new_enum<qtplugin::PluginErrorCode>(
        "PluginErrorCode",
    ...
    // PluginError type
    auto error_type = lua.new_usertype<qtplugin::PluginError>(
        "PluginError",
        sol::constructors<qtplugin::PluginError(),
                          qtplugin::PluginError(qtplugin::PluginErrorCode,
                                                const std::string&)>());
...
void register_core_bindings(sol::state& lua) {
    ...
    core["create_error"] = [](qtplugin::PluginErrorCode code,
    ...
    core["capability_to_string"] =
        ...
        switch (capability) {
            ...
            case qtplugin::PluginCapability::UserInterface:
                return "UserInterface";
            case qtplugin::PluginCapability::NetworkAccess:
                return "NetworkAccess";
            case qtplugin::PluginCapability::FileSystemAccess:
                return "FileSystemAccess";
            case qtplugin::PluginCapability::DatabaseAccess:
            ...
            case qtplugin::PluginCapability::Monitoring:
                return "Monitoring";
            case qtplugin::PluginCapability::Communication:
