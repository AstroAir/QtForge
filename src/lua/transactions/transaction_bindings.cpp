...
#include "../../../include/qtplugin/transactions/plugin_transaction_manager.hpp"
...
void register_transaction_bindings(sol::state& lua) {
    ...
    lua.new_enum<qtplugin::IsolationLevel>("IsolationLevel", {
    ...
    auto manager_type = lua.new_usertype<qtplugin::PluginTransactionManager>("PluginTransactionManager");
    manager_type["begin_transaction"] = &qtplugin::PluginTransactionManager::begin_transaction;
    manager_type["commit_transaction"] = &qtplugin::PluginTransactionManager::commit_transaction;
    manager_type["rollback_transaction"] = &qtplugin::PluginTransactionManager::rollback_transaction;
    manager_type["has_transaction"] = &qtplugin::PluginTransactionManager::has_transaction;
    manager_type["get_active_transactions"] = &qtplugin::PluginTransactionManager::get_active_transactions;
    manager_type["set_default_timeout"] = &qtplugin::PluginTransactionManager::set_default_timeout;
    manager_type["get_default_timeout"] = &qtplugin::PluginTransactionManager::get_default_timeout;
    manager_type["clear_completed_transactions"] = &qtplugin::PluginTransactionManager::clear_completed_transactions;

    // Factory function for singleton access
    transactions["get_transaction_manager"] = []() -> qtplugin::PluginTransactionManager& {
        return qtplugin::PluginTransactionManager::instance();
    };

    qCDebug(transactionBindingsLog) << "Transaction bindings registered successfully";
}
