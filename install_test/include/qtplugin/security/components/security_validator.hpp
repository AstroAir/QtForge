...
public:
     ...
     */
    virtual SecurityValidationResult validate_file_integrity(
     ...
     * @return Validation result
     */
    virtual SecurityValidationResult validate_metadata(
        const std::filesystem::path& file_path) const = 0;
     ...
     */
    virtual bool is_safe_file_path(
        const std::filesystem::path& file_path) const = 0;
     ...
     */
    virtual bool has_valid_extension(
        const std::filesystem::path& file_path) const = 0;
     ...
     * @return Validation result
     */
    virtual SecurityValidationResult validate_basic_security(
...
signals:
     ...
     */
    void security_violation_detected(const QString& file_path,
...
private:
    ...
    SecurityValidationResult create_validation_result(
