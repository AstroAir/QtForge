...
# For cross-compiling QtForge to RISC-V based embedded Linux systems
...
# Compiler flags for RISC-V 64-bit
set(RISCV_CPU_FLAGS "-march=rv64gc -mabi=lp64d")
set(CMAKE_C_FLAGS_INIT "${RISCV_CPU_FLAGS} -fPIC")
set(CMAKE_CXX_FLAGS_INIT "${RISCV_CPU_FLAGS} -fPIC")
...
set(QTFORGE_TARGET_ARCH "riscv64")
...
set(CPACK_PACKAGE_ARCHITECTURE "riscv64")
