...
# For cross-compiling QtForge to ARM64-based embedded Linux systems
...
# Compiler flags for ARM64 Cortex-A series
set(ARM64_CPU_FLAGS "-mcpu=cortex-a53 -mtune=cortex-a53")
set(CMAKE_C_FLAGS_INIT "${ARM64_CPU_FLAGS} -fPIC")
set(CMAKE_CXX_FLAGS_INIT "${ARM64_CPU_FLAGS} -fPIC")
...
set(QTFORGE_TARGET_ARCH "aarch64")
