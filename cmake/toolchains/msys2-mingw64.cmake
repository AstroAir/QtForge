...
# For building QtForge with MSYS2 MinGW64 environment
...
if(NOT $ENV{MSYSTEM} STREQUAL "MINGW64")
    message(WARNING "This toolchain is optimized for MINGW64. Current MSYSTEM: $ENV{MSYSTEM}")
endif()
...
if(NOT CMAKE_C_COMPILER)
    message(FATAL_ERROR "MinGW64 GCC compiler not found. Please install mingw-w64-x86_64-gcc")
endif()

if(NOT CMAKE_CXX_COMPILER)
    message(FATAL_ERROR "MinGW64 G++ compiler not found. Please install mingw-w64-x86_64-gcc")
endif()
...
set(MINGW64_FLAGS "-m64 -march=x86-64 -mtune=generic")
set(CMAKE_C_FLAGS_INIT "${MINGW64_FLAGS}")
set(CMAKE_CXX_FLAGS_INIT "${MINGW64_FLAGS}")
...
# Qt6 settings for MSYS2
set(Qt6_DIR "${MSYS2_ROOT}/lib/cmake/Qt6")
set(QT_QMAKE_EXECUTABLE "${MSYS2_ROOT}/bin/qmake.exe")

# QtForge specific settings for MSYS2
set(QTFORGE_IS_MSYS2 ON)
set(QTFORGE_IS_MINGW64 ON)
set(QTFORGE_TARGET_ARCH "x64")
set(QTFORGE_TARGET_PLATFORM "msys2-mingw64")

# Enable Windows-specific features
set(QTFORGE_BUILD_SHARED ON CACHE BOOL "Build shared libraries on MSYS2")
set(QTFORGE_BUILD_EXAMPLES ON CACHE BOOL "Build examples on MSYS2")

# Package configuration
set(CPACK_GENERATOR "ZIP;NSIS")
set(CPACK_PACKAGE_ARCHITECTURE "x64")
set(CPACK_SYSTEM_NAME "msys2-mingw64")
...
message(STATUS "QtForge: Using MSYS2 MinGW64 toolchain")
